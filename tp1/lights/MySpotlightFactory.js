...
export class MySpotlightFactory {
    /**
     * 
     * @param {{ color: THREE.ColorRepresentation, intensity: number, angle: number, distance?: number, penumbra?: number, decay?: number} & ({castShadows?: false} | {castShadows: true, shadowsOptions: { near: number, far: number, fov: number }})} options 
     * @returns 
     */
    buildSpotlight({ color = 0xffffff, intensity, angle, distance = 0, penumbra = 1, decay = 0, ...shadows }) {
